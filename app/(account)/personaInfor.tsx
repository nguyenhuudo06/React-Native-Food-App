...
import { callProfile, callUpdateProfile } from "@/services/api-call";
...
const MyTabView = () => {
  ...
  const handleLogin = async (values) => {
    ...
    try {
      const responseUpdateProfile = await callUpdateProfile(values.fullName, values.email);

      if(responseUpdateProfile.status < 200 || responseUpdateProfile.status >= 300) {
        throw new Error("Request failed with status " + responseUpdateProfile.status);
      }
        ...
        <View style={{ padding: Spacing }}>
          ...
          {isVisibleEditInfo ? (
            ...
            >
              ...
              <View>
                <Formik
                  initialValues={{ fullName: userData.user_name || "", email: userData.email || "" }}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <MaterialIcons name="edit-note" size={Spacing * 2} color="white"  />
